...
class AuthResponseModel {
  ...
  factory AuthResponseModel.fromJson(Map<String, dynamic> json) {
    return AuthResponseModel(
      ...
      session: json['session'] != null ? AuthSession(
        accessToken: json['session']['access_token'] as String,
        refreshToken: json['session']['refresh_token'] as String,
        expiresAt: DateTime.fromMillisecondsSinceEpoch((json['session']['expires_at'] as int) * 1000),
        user: json['user'] != null ? UserModel.fromJson(json['user'] as Map<String, dynamic>) as User : User(
